...
import (
	readerGrpc "github.com/AleksK1NG/cqrs-microservices/product_reader_service/internal/product/delivery/grpc"
...
func (s *server) newReaderGrpcServer() (func() error, *grpc.Server, error) {
	...
	readerGrpcService := readerGrpc.NewReaderGrpcService(s.log, s.cfg, s.v, s.ps)
